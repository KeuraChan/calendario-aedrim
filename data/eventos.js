...
const eventos = [
  ...
  },
  {
    ...
    eventos: [
	 ...
	 "Uma batalha se sucede que custa a vida de Caleb, Elenora e Asmodeus.",
	 "Tharok, que havia chegado atrasado e Feenéris afugentam o dragão, que sai vivo.",
	 "Todo a região do farol desmorona. Criando 'As Ruínas de Água Turva'.",
	 "Feenéris e Tharok conhecem Drake e seu grupo, que ressucitam Elonora e Caleb.",
    ],
    comemorativa: false,
  },
 {
    ...
    dia: 69,
    eventos: [
     "Caleb, Elenora, Feenéris e Tharok retornam às Ruínas de Caleb, onde encontram o Braão 'O Olho', consertando o Água Negra, dando ao grupo como um presente após descobrirem que Asmodeus está novamente vivo.",
    ],
    comemorativa: false,
  },
  {
...
},
{
  ...
  eventos: [
	...
	"Varis, explora a região por alguma comida, notando sobreviventes na cratera da antiga Queldor, presenciando a destruição, o mesmo entega a comida e jóias que possuiam em sua carroça",
	"Entregando ao grupo o certificado da missão realizada, a corraça e três dos cavalos, Varis retorna para cidade, tentar ajudar os sobreviventes e se recuperar.",
...
},
{
  ...
  eventos: [
	...
	"Aventureiros chegam à cidade Taverna do Dragão Dormente com o corpo dilacerado de um unicórnio.",
	...
	"Caminhando com os elfos da cidade que invadiram o templo, o grupo se reúne, com Ceres se unindo a eles, finalmente deixando a sala, mas não antes de Tilayra e Vésperus Luthier quebrarem o braço do sacerdote Abramo.",
	"O grupo, composto por Vésperus, Tilayra, Rafaella, Apis, Ceres, Dorian, Llywillan e Ciris, segue pelas ruas de Madeira à Deriva. A multidão, composta pelos cultistas e outros habitantes ameaçados pela ação do grupo, se move pelas ruas atrás dos responsáveis pela queima do templo.",
	"Recuperando sua carroça, Vésperus, Tilayra, Rafaella, Apis, Ceres, Dorian, Llywillan e Ciris seguem até o eremita Ramne, que os abriga em um demi-plano.",
	...
	"Vésperus, Tilayra, Rafaella, Apis, Ceres, Dorian e Llywillan deixam a cidade escondidos, seguindo para as florestas inundadas ao nordeste.",
	"Seguindo o caminho, Apis ajuda a guiá-los, encontrando mais Sinos da Morte pelo trajeto, junto do rastro que o grupo acredita ser do culto ao Deus Réptil.",
	"Nesse caminho, iluminado pela luz conjurada por Rafaella, eles avistam um ogro e, sem pensar duas vezes, o destroem, não sobrando nada além de uma carcaça.",
	"No percurso, enquanto procuravam um ponto seguro para descansar e buscavam suprimentos para o acampamento, eles são emboscados por zumbis antes de caírem no sono.",
  ],
  comemorativa: false
},
{
...
},
{
  ...
  eventos: [
		...
		"Tilayra foi à frente e com um ataque surpresa, perdeu sua forma animal. O grupo avançou para ajudá-la, e durante a luta intensa, Luthier revelou a todos que um dos cultistas que os atacava era Jack, membro desaparecido do grupo. Após uma luta intensa, em que muitos cultistas foram mortos e/ou nocauteados, o grupo tomou a importante decisão de restringir fisicamente todos os afetados e manter Jack contido nos quartos dos cultistas até resolverem a situação com o dragão o mais rápido possível.",
	  	"Apis, Ceres, Luthier, Lliwilan, Dorian e Tilayra aproveitaram da paz momentânea de uma cela para descansarem e identificarem Alguns itens antes pertencentes ao cultista chamado Primo. Luthier e Rafaella observaram a presença da marca da Companhia Negra na mão/corpo do primo e suas atenções foram redobradas.",
		"Luthier identificou uma gargantilha mágica encontrada no ninho da harpia previamente derrotada e se sintonizou com ela. O grupo então retornou à estátua do dragão onde Tilayra previamente mexeu a cabeça da cobra na estátua e após forçarem novamente o movimento, conseguiram abrir uma passagem secreta.",
...
},
{
  ...
  eventos: [
    ...
    "Seguindo para o leste de Taverna do Dragão Dormente, os aventureiros encontram uma antiga tumba com duas flechas inscritas com runas mágicas.",
...
},
{
  ...
  dia: 20,
  eventos: [
    "Chegando a Madeira à Deriva, Apis, Ceres, Rafaella, Lliwilan, Dorian, Jack e Tilayra seguem direto para a Serpente Sonolenta, dormindo da tarde até o dia seguinte.",
    "Charlotte, Crinvok, Teperson, Varis e Nyco despertam e sofrem uma tentativa de assalto por um grupo de guerra orc, o qual derrotam com uma bola de fogo lançada por Varis.",
    "Seren, uma nômade e leitora de cartas, chega à cidade de Dragão Dormente. Após jogar dados e ter a sorte lida por um Homem em Cinza, ela recebe um dado e é requisitada a entregá-lo à meia-celestial Charlotte. Investigando um pouco, ela parte em busca do grupo de aventureiros.",
